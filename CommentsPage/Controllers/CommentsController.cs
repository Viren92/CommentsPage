...
using CommentsPage.DAL;
using CommentsPage.Models;

namespace CommentsPage.Controllers
{
    public class CommentsController : Controller
    {
        private Comments1 db = new Comments1();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.CommentsList = new SelectList(db.Comments.ToList(), "Comments", "Comments");
            return View(comment);
        }
